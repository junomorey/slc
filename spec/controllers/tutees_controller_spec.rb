...
RSpec.describe TuteesController, type: :controller do
    ...
    # describe 'tutor match method works', :type => :controller do 
    #     it 'should match a tutor to a tutee' do
    ...
    #     tutee = instance_double("Tutee", :email => "apple@gmail.com", :password => "example", :password_confirmation => "example", :first_name => "Sally", :last_name => "Sue")
    #     expect {get :tutor_match, :id => "1"}.to change(Tutor, :count).by(0)
    #     expect(tutee.tutor_match).to equal(tutor)
    #     tutee.tutor_match
    #     end
    # end
end
